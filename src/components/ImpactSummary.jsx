    ...
    return (
        <div className="impact-grid">
            <div className="impact-card green" onClick={() => onNavigate?.('logs')} style={{ cursor: 'pointer' }}>
                <div className="card-header">
                    <div className="title-group">
                        <p>{t('dashboard.total_weight')}</p>
                        <h3>{user.total_weight || 0} <span className="unit">{t('common.kg')}</span></h3>
                    </div>
            ...
            <div className="impact-card blue" onClick={() => onNavigate?.('rewards')} style={{ cursor: 'pointer' }}>
                <div className="card-header">
                    <div className="title-group">
                        <p>{t('dashboard.eco_points')}</p>
                        <h3>{user.eco_points || 0} <span className="unit">{t('common.pts')}</span></h3>
                    </div>
